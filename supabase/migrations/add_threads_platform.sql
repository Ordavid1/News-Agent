-- ============================================
-- ADD THREADS TO PLATFORM CONSTRAINTS
-- Run this in Supabase SQL Editor
-- ============================================

-- Update social_connections platform constraint to include 'threads'
...
ALTER TABLE public.social_connections ADD CONSTRAINT social_connections_platform_check
  CHECK (platform IN ('twitter', 'linkedin', 'reddit', 'facebook', 'instagram', 'tiktok', 'youtube', 'telegram', 'whatsapp', 'threads'));

-- Update agents platform constraint to include 'threads'
